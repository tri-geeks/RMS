$(document).ready(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: 'Order Date', name: 'OrderDate', width: 200, editable: true },
            { label: 'Freight', name: 'Freight', width: 200, editable: true },
            { label: 'Ship Name', name: 'ShipName', width: 250, editable: true },
            {
                label: 'Commit|Cancel',
                name: 'LinkButton',
